...
public interface CymbolListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link CymbolParser#xINT}.
	 * @param ctx the parse tree
	 */
	void enterXINT(CymbolParser.XINTContext ctx);
	/**
	 * Exit a parse tree produced by {@link CymbolParser#xINT}.
	 * @param ctx the parse tree
	 */
	void exitXINT(CymbolParser.XINTContext ctx);
}